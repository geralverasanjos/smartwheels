        ...
        <div className="flex flex-col gap-8">
            ...
            <Card className="text-center">
                ...
                <CardContent className="flex flex-wrap justify-center gap-2">
                    <Button asChild><Link href="/dashboard/driver/wallet/add-funds"><PlusCircle className="mr-2 h-4 w-4" />{t('btn_add_funds')}</Link></Button>
                    <Button asChild variant="outline"><Link href="/dashboard/driver/wallet/withdraw"><ArrowDown className="mr-2 h-4 w-4" /> {t('btn_withdraw')}</Link></Button>
                    <Button asChild variant="outline"><Link href="/dashboard/driver/wallet/transfer"><Send className="mr-2 h-4 w-4" /> {t('btn_transfer')}</Link></Button>
                    <Button asChild variant="outline"><Link href="/dashboard/driver/wallet/receive"><QrCode className="mr-2 h-4 w-4" /> {t('btn_receive')}</Link></Button>
                </CardContent>
            </Card>
