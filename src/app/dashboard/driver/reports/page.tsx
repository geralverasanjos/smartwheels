  ...
  return (
    <div className="space-y-8">
       <div className="panel-header flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
                <h1 className="text-3xl font-bold font-headline">{t('reports_page_title_driver')}</h1>
                <p className="text-muted-foreground">{t('reports_page_subtitle_driver')}</p>
            </div>
       ...
       <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <StatCard icon={BarChart2} title={(user?.rating || 0).toFixed(1)} subtitle={t('reports_avg_rating')} />
      </div>
