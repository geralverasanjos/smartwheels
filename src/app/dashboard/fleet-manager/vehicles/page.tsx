...
import { getVehiclesByFleet, saveVehicle } from '@/services/vehicleService'; // We'll need a new service function
    ...
    useEffect(() => {
        const fetchVehicles = async () => {
            ...
            try {
                ...
                const vehicleData = await getVehiclesByFleet(user.id);
                            ...
                            <CardContent>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div><p className="text-muted-foreground">{t('field_color')}:</p><p className="font-semibold">{vehicle.color}</p></div>
                                     {vehicle.driverId ? <p>Atribuído a: {vehicle.driverId}</p> : <p>Não atribuído</p>}
                                </div>
